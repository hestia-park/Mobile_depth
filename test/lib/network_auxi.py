...
class Decoder(nn.Module):
    def __init__(self):
        ...
        # self.inchannels = [dim  for dim in cfg.MODEL.RESNET_BOTTLENECK_DIM[1:]]  # [128, 256, 512, 1024]
        # self.midchannels =[dim  for dim in  cfg.MODEL.LATERAL_OUT[::-1] ]
        self.inchannels = [64, 128, 256, 256]
        self.midchannels = [256, 256, 256, 384]  #[256, 256, 256, 256]
...
class DepthNet(nn.Module):
    ...
    def __init__(self,
        ...
        # self.inchannels = [dim  for dim in cfg.MODEL.RESNET_BOTTLENECK_DIM[1:]]  # [128, 256, 512, 1024]
        # self.midchannels =[dim  for dim in  cfg.MODEL.LATERAL_OUT[::-1] ]
    # __C.MODEL.RESNET_BOTTLENECK_DIM = [64, 64, 128, 256, 256]
    # __C.MODEL.RESNET_BLOCK_DIM = [64, 64, 128, 256, 256]

    # # Configure the decoder
    # __C.MODEL.FCN_DIM_IN = [384, 256, 256, 256, 256, 256]
    # # __C.MODEL.FCN_DIM_OUT = [256, 256, 256, 256, 256]
    # __C.MODEL.LATERAL_OUT = [384, 256, 256, 256] #[256, 256, 256, 256]

        # self.inchannels = [256, 512, 1024, 2048]
        # self.midchannels = [256, 256, 256, 512]
        self.inchannels =[64, 128, 256, 256]
        self.midchannels = [384, 256, 256, 256]
        self.upfactors = upfactors
        self.outchannels = 1

        # Build model
        if self.backbone == 'resnet':
            print("encoder is resnet")
            ...
            self.encoder = Resnet.resnet34(pretrained=self.pretrained)
        else:
