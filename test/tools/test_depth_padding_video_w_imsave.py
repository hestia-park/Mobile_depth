...
if __name__ == '__main__':
    ...
    while success:
        ...
        if count % 3 == 0:
            ...
            img_name = os.path.basename(video_file_path[:-4])
            ...
            cv2.imwrite(os.path.join(args.save_folder, img_name+str(count)+'.png'), (pred_depth_ori/pred_depth_ori.max() * 60000).astype(np.uint16))
